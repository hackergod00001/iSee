...
//  NotchNotification
//
//  Created by 秋星桥 on 2024/9/19 and Modified by Upmanyu Jha on 10/25/2025
//
...
struct NotificationContext {
    ...
    @discardableResult
    func open(forInterval interval: TimeInterval = 0) -> NotchViewModel {
        ...
        guard interval > 0 else { return viewModel }
